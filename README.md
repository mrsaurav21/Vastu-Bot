...
src/engine/Canvas3D.jsx
src/engine/Wall.jsx
src/engine/Furniture.jsx
src/store/useDesignStore.js
...
# phase 2
Client ID:- 92793150715-2sd74sbfoftgk8hbfh6k5uk9tevsqepe.apps.googleusercontent.com
Client secret :- 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

Mongodb 
username:-sauravsingh21005_db_user
Passowrd:- N9hdYIS8rQ9NmYaa
connection link :- mongodb+srv://sauravsingh21005_db_user:N9hdYIS8rQ9NmYaa@vastu.yuug56i.mongodb.net/?appName=Vastu

Here are the specific frontend files we will need to modify or create to connect everything to your new backend:
...
src/main.jsx 
src/services/api.js 
src/pages/store/useDesignStore.js 
src/components/Navbar.jsx 
src/pages/Profile.jsx 
src/pages/Editor.jsx 
